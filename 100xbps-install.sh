...
sudo xbps-install font-iosevka plank picom xcompmgr feh geany pcmanfm Thunar thunar-volman thunar-archive-plugin xarchiver unzip xdo base-devel arandr lxsession lxappearance git dmenu rofi neofetch xterm xfce4-whiskermenu-plugin 
...
sudo xbps-install parcellite kwin kvantum lxqt plank lolcat-c
